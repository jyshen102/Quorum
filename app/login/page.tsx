    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 w-full max-w-sm text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-gray-900 text-white rounded-xl px-5 py-3 text-sm font-medium hover:bg-gray-800 transition-colors"
        >
        ...
        <p className="text-xs text-gray-400 mt-6">
          Only the organizer needs to sign in. Respondents use a shared link.
        </p>
      </div>
    </div>
  )
